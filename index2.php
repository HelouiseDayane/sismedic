            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="config.html"><i data-feather="settings"></i><span>Configurações</span></a>
                  </li>
                </ul>
              </div>
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="header-top d-sm-flex align-items-center">
                      <h5>Visão geral do crescimento</h5>
                ...
                <div class="card income-card">
                  <div class="card-header">
                    <div class="header-top d-sm-flex align-items-center">
                      ...
                      <div class="center-content">
                        <p class="d-sm-flex align-items-center"><span class="font-primary m-r-10 f-w-700">R$8.25k</span><i class="toprightarrow-primary fa fa-arrow-up m-r-10"></i>86% maior que o último mês</p>
                      </div>
                      <div class="setting-list">
                        <ul class="list-unstyled setting-option">
                          <li>
                              ...
                              <tr>
                                <td>
                                  <div class="media">
                                    ...
                                    <div class="media-body"><span>Sessão de Fisioterapia</span>
                                      <p>10:00 Hrs</p>
                                    </div>
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="media">
                                    ...
                                    <div class="media-body"><span>Sessão de pilates</span>
                                      <p>13:00 Hrs</p>
                                    </div>
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="media">
                                    ...
                                    <div class="media-body"><span>Reunião com gestores</span>
                                      <p>16:00 Hrs</p>
                                    </div>
                                  </div>
                                </td>
