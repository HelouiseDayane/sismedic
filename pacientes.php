              ...
              <div class="col-sm-6 col-md-3">  
                <div class="form-group form-focus">
                 <div class="linha">
                  ...
                  <input type="text" class="form-control floating" placeholder="Digite o nome do paciente...">
                 </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-3">  
                <a href="cadastro.php" class="btn btn-danger btn-block">
                  <span></span>
                  <span></span>
                  <span></span>
                  <span></span>
              ...
              <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div class="profile-widget">
                  <div class="profile-img">
                   <img class="avatar" src="assets/images/avtar/profile.jpg" alt=""></a>
                  </div>
                  <div class="texto">
                    <a href="perfil.php"><h1>Rosana Alves</h1></a> 
                    <h2>rosana@gmail.com</h2>
                    <h3>(84)9999-9999</h3>
                  </div>
                </div>
              </div>
