...
<html lang="en">
  <head>
    ...
    <title>Yghor Meira - Enter your credential</title>
    <!-- Google font-->
  ...
  <body class="vsc-initialized dark-only">
    ...
    <section>
      <div class="container-fluid">
        <div class="row">
          <div class="col-xl-7"><img class="bg-img-cover bg-center" src="../lib/images/login/2.png" alt="looginpage"></div>
          <div class="col-xl-5 p-0">
            <div class="login-card">
              <form class="theme-form login-form" autocomplete="on">
                <h4>Login</h4>
                <h6>Seja bem vindo! Faça login para acessar o sistema.</h6>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    ...
                    <div class="show-hide">                       </span></div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="checkbox">
                    <label class="newcheck text-muted" for="checkbox1">
                      <input id="checkbox1" type="checkbox" name="save" value=""/>
  ...
  <SCRIPT>
    ...
    setInterval(
          function(){
            if(dark==0){
              $('body').attr("class","vsc-initialized dark-only");
              dark=1;
            }else{
              $('body').attr("class","");
              dark=0;
