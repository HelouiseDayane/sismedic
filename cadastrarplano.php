            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                ...
                <ul class="notification-dropdown onhover-show-div">
                  <li>
                    <p class="f-w-700 mb-0">Quatro notificações<span class="pull-right badge badge-primary badge-pill">4</span></p>
                  </li>
                  <li class="noti-primary">
                    <div class="media"><span class="notification-bg bg-light-primary"><i data-feather="activity"> </i></span>
                      <div class="media-body">
                        <p>Boleto pago </p><span>10 minutos atrás</span>
                      </div>
                    </div>
                  </li>
                  <li class="noti-secondary">
                    <div class="media"><span class="notification-bg bg-light-secondary"><i data-feather="check-circle"> </i></span>
                      <div class="media-body">
                        <p>Tratamento completo</p><span>1 hora atrás</span>
                      </div>
                    </div>
                  </li>
                  <li class="noti-success">
                    <div class="media"><span class="notification-bg bg-light-success"><i data-feather="file-text"> </i></span>
                      <div class="media-body">
                        <p>Boleto gerado</p><span>3 horas atrás</span>
                      </div>
                    </div>
                  </li>
                  <li class="noti-danger">
                    <div class="media"><span class="notification-bg bg-light-danger"><i data-feather="user-check"> </i></span>
                      <div class="media-body">
                        <p>Boleto cancelado</p><span>6 horas atrás</span>
                      </div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="chat-dropdown onhover-show-div">
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="assets/images/user/4.jpg" alt="">
                      ...
                      <p class="f-12">32 minutos atrás</p>
                    </div>
                  </li>
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="assets/images/user/1.jpg" alt="">
                      ...
                      <p class="f-12">58 minutos atrás</p>
                    </div>
                  </li>
                  <li>
            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="config.php"><i data-feather="settings"></i><span>Configurações</span></a>
                    </li>
                  </ul>
              </div>
                          ...
                          <div class="row">
                            <div class="mb-3 col-sm-9">
                              <div class="mb-3 col-sm-12">
                                ...
                                <input class="form-control" placeholder="Digite o nome do plano...">
                              </div>
                              <div class="mb-3 col-sm-12">
                                <h6 class="form-label">Descrição</h6>
                                <textarea class="form-control" rows="5" placeholder="Digite a descrição do plano..."></textarea>
                              </div>
                              <div class="row">
                                ...
                                <div class="mb-3 col-sm-3">
                                    <label class="form-label">Carregar imagem do plano</label>
                                    <input type="file" class="carregar">
                                </div>
                              </div>
                            </div>
                            <div class="mb-3 col-sm-3">
                              <img class="planodef" src="assets/images/planos/default.png">
                            </div>
                          </div>
                          <div class="form-footer">
                            <button class="btn btn-primary btn-block">Cadastrar Plano</button>
                          </div>
                        </form>
                      </div>
                    </div>
