          ...
          <div class="container-fluid">
            <div class="card">
              ...
              <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <label for="inputEmail4">Quantidade de repetições</label>
                ...
                <div class="row">
                    <div class="mb-3 col-sm-6">
                        <label for="inputEmail4">Endereço da cobrança</label>
                    ...
                    <table class="table table-bordered table-striped">
                      <tbody>
                        <tr>
                          ...
                          <td class="Hours">
                            <h6 class="p-2 mb-0">DATA DO SERVIÇO</h6>
                          </td>
                          <td class="Rate">
                            <h6 class="p-2 mb-0">TRATAMENTO</h6>
                          </td>
                          <td class="subtotal">
                            <h6 class="p-2 mb-0">DESCRIÇÃO</h6>
                          </td>
                          <td class="subtotal">
                            <h6 class="p-2 mb-0">QTDE</h6>
                          </td>
                          <td class="subtotal">
                            <h6 class="p-2 mb-0">R$ UNITÁRIO</h6>
                          </td>
                          <td class="subtotal">
                            <h6 class="p-2 mb-0">VALOR</h6>
                          </td>
                          <td class="subtotal">
                            <h6 class="p-2 mb-0">OPÇÃO</h6>
                          </td>
                        </tr>
                        <tr>
                          <td>
