                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        ...
                                        <a href="profile.php">Richard Miles <span>Avaliação</span></a>
                                    </h2>
                                </td>
                                ...
                                <td>
                                    <div class="user-add-shedule-list">
                                        <h2>
                                            <a href="#" data-toggle="modal" data-target="#edit_schedule" style="border:2px dashed #1eb53a">
                                            <span class="username-info m-b-10">6:30 - 9:30</span>
                                            <span class="userrole-info">Avaliação</span>
                                            </a>
                                        </h2>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        ...
                                        <a href="profile.php">Jeffrey Warden <span>Avaliação</span></a>
                                    </h2>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        ...
                                        <a href="profile.php">Bernardo Galaviz <span>Avaliação</span></a>
                                    </h2>
                                </td>
                                <td>
                                    <div class="user-add-shedule-list">
